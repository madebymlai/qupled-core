...
class MetacognitiveStrategies:
    ...
    def get_study_tips(
        self, topic: str, difficulty: DifficultyLevel, mastery: MasteryLevel
    ) -> List[StudyTip]:
        """
    ...
    def get_self_assessment_prompts(
        self, topic: str, mastery: MasteryLevel
    ) -> List[SelfAssessment]:
        """
    ...
    def get_retrieval_practice_suggestions(
        self, time_since_last_review: int, mastery: MasteryLevel
    ) -> List[RetrievalPractice]:
        """
